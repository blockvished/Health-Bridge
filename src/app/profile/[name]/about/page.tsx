...
export default function ProfilePage({ params }: PageProps) {
  ...
  // Move ratings hooks to top level
  ...
  // Move ratings fetch effect to top level
  useEffect(() => {
    ...
    fetchRatingsData();
  }, [profileData?.doctor?.id]); // Fixed dependency
  ...
  const renderProfileContent = () => {
    ...
    return (
      <>
        ...
        {/* Education Section - Using imported component */}
        <EducationSection educations={profileData.educations} />

        {/* Experience Section - Using imported component */}
