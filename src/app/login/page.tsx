      ...
      <div className="bg-white shadow-lg rounded-2xl w-full max-w-4xl flex overflow-hidden">
        ...
        <div className="w-full md:w-2/3 p-8 flex flex-col justify-center">
          <div className="text-center">
            ...
            />
            <h2 className="text-3xl font-bold text-gray-800">Sign in to Live Doctors</h2>
          ...
          <p className="mt-4 text-center text-gray-600 text-sm mx-4">
            Don't have an account? <Link href="/register" className="text-blue-500 font-medium">Register</Link>
          </p>
        </div>
      </div>
    </div>
