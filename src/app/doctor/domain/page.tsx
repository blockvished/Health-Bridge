...
const DomainTable = () => {
  ...
  const fetchDomains = async () => {
    ...
    try {
      ...
      toast.error("An unexpected error occurred while fetching domains.");
    } finally {
  ...
  const fetchDnsSettings = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        toast.error(data.error || "Failed to fetch DNS settings.");
        return;
      }
      ...
      toast.error("An unexpected error occurred while fetching DNS settings.");
    } finally {
      setDnsLoading(false);
    }
  };
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        toast.error(data.error || "Failed to add custom domain.");
        return;
      }
  ...
  return (
    <>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gray-50 rounded-md p-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <code className="bg-white px-2 py-1 rounded border text-sm">
                          {dnsSettings.serverIp}
                        </code>
                        <button
                          onClick={() =>
                            copyToClipboard(dnsSettings.serverIp, "serverIp")
                          }
                        ...
                        <div className="p-4 space-y-3">
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                <code className="bg-gray-100 px-2 py-1 rounded text-sm w-full">
                                  {dnsSettings.type1}
                                </code>
                                <button
                                  onClick={() =>
                                    copyToClipboard(dnsSettings.type1, "type1")
                                  }
                                  className="text-blue-600 hover:text-blue-800"
                                  title="Copy to clipboard"
                                >
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  onClick={() =>
                                    copyToClipboard(dnsSettings.host1, "host1")
                                  }
                                  className="text-blue-600 hover:text-blue-800"
                                  title="Copy to clipboard"
                                >
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  onClick={() =>
                                    copyToClipboard(dnsSettings.ttl1, "ttl1")
                                  }
                                  className="text-blue-600 hover:text-blue-800"
                                  title="Copy to clipboard"
                                >
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                onClick={() =>
                                  copyToClipboard(dnsSettings.value1, "value1")
                                }
                                className="text-blue-600 hover:text-blue-800"
                                title="Copy to clipboard"
                              >
                        ...
                        <div className="p-4 space-y-3">
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  onClick={() =>
                                    copyToClipboard(dnsSettings.type2, "type2")
                                  }
                                  className="text-blue-600 hover:text-blue-800"
                                  title="Copy to clipboard"
                                >
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  onClick={() =>
                                    copyToClipboard(dnsSettings.host2, "host2")
                                  }
                                  className="text-blue-600 hover:text-blue-800"
                                  title="Copy to clipboard"
                                >
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  onClick={() =>
                                    copyToClipboard(dnsSettings.ttl2, "ttl2")
                                  }
                                  className="text-blue-600 hover:text-blue-800"
                                  title="Copy to clipboard"
                                >
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                onClick={() =>
                                  copyToClipboard(dnsSettings.value2, "value2")
                                }
                                className="text-blue-600 hover:text-blue-800"
                                title="Copy to clipboard"
                              >
                    ...
                    <div className="bg-yellow-50 border border-yellow-200 rounded-md p-4">
                      ...
                      <ul className="list-disc list-inside text-yellow-700 text-sm space-y-1">
                        ...
                        <li>
                          Contact your domain registrar or hosting provider if you
                          need help adding these records
                        </li>
                        <li>
                          You can use online DNS checker tools to verify the
              ...
              {domains.length === 0 ? (
                ...
                domains.map((domain, index) => (
                  <tr key={domain.id} className="border-t border-gray-300">
                    ...
                    <td className="p-2">
                      {new Date(domain.createdAt).toLocaleDateString("en-IN", {
                        year: "numeric",
                        month: "short",
                        day: "numeric",
                      })}
                    ...
                    <td
                      className={`p-2 ${domain.status === "active" ? "text-green-600" : "text-red-600"} capitalize`}
                    >
                      {domain.status}
                    </td>
                  </tr>
      ...
      {/* Toast Container - Moved outside with higher z-index */}
      <ToastContainer
        position="top-right"
        autoClose={3000}
        hideProgressBar={false}
