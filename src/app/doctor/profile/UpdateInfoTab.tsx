...
const UpdateInfoTab: React.FC<UpdateInfoTabProps> = ({
  ...
  const handleSaveChanges = async () => {
    ...
    if (!doctorrData.name.trim()) {
      toast.error("Name is required");
      return;
    }

    if (!doctorrData.email.trim()) {
    ...
    try {
      setIsLoading(true);
      toast.info("Saving changes...", { autoClose: 1000 });
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData || "Failed to update doctor info");
      }
        ...
        <div className="flex flex-wrap gap-8 mb-6">
          ...
          <div className="flex flex-col items-center">
            ...
            <button
              ...
              className="mt-2 bg-gray-100 text-gray-600 px-3 py-2 rounded flex items-center space-x-2 text-sm cursor-pointer hover:bg-gray-200 transition-colors"
            >
