...
export default function BulkImportDrugs() {
  return (
    <div className="w-full max-w-2xl">
      {/* Left-aligned Download CSV Template */}
      ...
      <div className="bg-white p-5 rounded-lg shadow-md w-full max-w-2xl">
        ...
        <div className="border-t border-gray-200 pt-4">
          ...
          <div className="flex items-center gap-2">
            {/* Square, gray Choose File button */}
            <label
              htmlFor="file-upload"
              className="bg-gray-200 text-gray-700 w-10 h-10 flex items-center justify-center rounded-md text-sm cursor-pointer hover:bg-gray-300"
            >
              📂
            </label>
            <input
