...
const rolePermissions = [
  "Services", "Drugs", "Ratings & Review", "Consultation", "Custom Domain", 
  "Schedule", "Blogs", "Appointments", "Prescription", "Affiliate", 
  "QR Code", "Department", "Doctor Profile", "Patients", 
  "Prescription Settings", "Payouts", "Consultation Settings"
];
  ...
  return (
    <div className="bg-white rounded-lg max-w-4xl mx-auto w-full p-6">
      ...
      <div className="flex justify-between items-center mb-10">
        ...
        <h1 className="text-xl font-medium text-center flex-grow">Add new staff</h1>
      ...
      <div className="space-y-6">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Chambers</label>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-2">Email (Username) <span className="text-red-500">*</span></label>
      ...
      {showAddStaff ? (
        ...
        <div className="bg-white shadow-md rounded-xl overflow-hidden w-full p-4 md:p-6">
          ...
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-xl md:text-2xl font-semibold text-gray-800">Staff</h1>
            <button
