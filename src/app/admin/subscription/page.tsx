            ...
            <div className="bg-white border rounded-lg shadow p-6">
              ...
              <table className="w-full border-collapse border-0">
                <tbody>
                  ...
                  <tr className="border-b border-gray-200">
                    <td className="p-3 text-gray-700 font-medium">Billing Cycle:</td>
                  ...
                  <tr>
                    ...
                    <td className="p-3 text-red-600 font-medium">
                      20 Jul 2025 <span className="text-gray-500">(129 Days left)</span>
                    </td>
                  </tr>
                  <tr>
                    <td className="p-3 text-gray-700 font-medium">Payment Status:</td>
                    <td className="p-3">
